...
/*
  ...
  await Hive.openBox('fomousstreamstaff').then(
        (value) => runApp(
      ScopedModel<LangModel>(model: LangModel(), child: MyApp(prefs: value)),
    ),
  );
...
class _MyAppState extends State<MyApp> {
  ...
  getToken() async {
    ...
    PrefObj.preferences!.put(PrefKeys.STAFF_APP_DEVICE_TOKEN, token);
...
const AndroidNotificationChannel fcm_channel = AndroidNotificationChannel(
  'famous_team_staff_channel_id',
  'famous_team_staff_channel_name',
