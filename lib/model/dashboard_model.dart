class DashboardModel {
  ...
  StationId? station;
  List<Orders>? orders;
  dynamic todayTotalServiceAmount;
  dynamic todayCompletedServiceAmount;
  dynamic todayCompletedServicePercentage;
  dynamic todayAcceptService;
  dynamic todayRejectService;
  dynamic  exception;
  ...
  DashboardModel(
      {this.staff,
        this.station,
        this.orders,
        this.todayTotalServiceAmount,
        this.todayCompletedServiceAmount,
        this.todayCompletedServicePercentage,
        this.todayAcceptService,
        this.todayRejectService,
        this.exception,
        });
  ...
  DashboardModel.fromJson(Map<String, dynamic> json) {
    ...
    station = json['station'] != null
        ? new StationId.fromJson(json['station'])
        : null;
    if (json['orders'] != null) {
      orders = <Orders>[];
    ...
    todayTotalServiceAmount = json['today_total_service_amount'];
    todayCompletedServiceAmount = json['today_completed_service_amount'];
    todayCompletedServicePercentage =
    json['today_completed_service_percentage'];
    todayAcceptService = json['today_accept_service'];
    todayRejectService = json['today_reject_service'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['today_total_service_amount'] = this.todayTotalServiceAmount;
    data['today_completed_service_amount'] = this.todayCompletedServiceAmount;
    data['today_completed_service_percentage'] =
        this.todayCompletedServicePercentage;
    data['today_accept_service'] = this.todayAcceptService;
    data['today_reject_service'] = this.todayRejectService;
  ...
  Orders.fromJson(Map<String, dynamic> json) {
    ...
    if (json['extra_service'] != null) {
      ...
      json['extra_service'].forEach((v) {
        extraService!.add(new ExtraService.fromJson(v));
      });
    }
